<template>
    <div class="menu-toggle fixed-top" @click="toggleMenu" style="margin-top: 7rem;">
      <svg 
        v-if="!menuVisible" 
    ...
    <ul class="fixed-top menu nav flex-column" v-if="menuVisible" style="margin-top: 10rem;">
      <NuxtLink to="/produk/form">
